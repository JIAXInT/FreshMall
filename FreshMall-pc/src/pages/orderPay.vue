<template>
  <div class="order-pay">
        ...
        <div class="order-wrap">
          <div class="item-order">
            ...
            <div class="order-info">
              ...
              <p>收货信息：小啊涛 178****0189 四川 成都市 都江堰市 青城山镇 东软大道</p>
            </div>
          ...
          <div class="item-detail" v-if="showDetail">
            ...
            <div class="item">
              ...
              <div class="detail-info">小啊涛 178****0189 四川 成都市 都江堰市 青城山镇 东软大道</div>
            </div>
            <div class="item good">
    ...
    <scan-pay-code v-if="showPay" :showPay="this.showPay='true'"></scan-pay-code>
  </div>
</template>
<script>
...
export default{
  ...
  methods:{
    ...
    goAliPay(cartItem){
      ...
      this.axios.post('http://www.justic.store:3002/api/pay',{
