<template>
  <div class="index">
    <div class="container">
      ...
      <div class="ads-box">
        <a href="/#/product/30" id=""><img src="/imgs/ads/ads-1.png" alt=""></a>
        <a href="/#/product/30" id=""><img src="/imgs/ads/ads-2.jpg" alt=""></a>
        <a href="/#/product/30" id=""><img src="/imgs/ads/ads-3.png" alt=""></a>
        <a href="/#/product/30" id=""><img src="/imgs/ads/ads-4.jpg" alt=""></a>
      </div>
    </div>
    <!-- 商品区域 -->
    <HomeProduct />
...
<style lang="scss">
  ...
  .index{
    background:url('/imgs/index-bg.png') no-repeat 50% 0;
    .swiper-box{
      .swiper-cube-shadow{
        width: 0;
      }
