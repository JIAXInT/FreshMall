  ...
  <div class="order-confirm">
        ...
        <div class="order-box">
          ...
          <div class="item-good">
            ...
            <ul>
              <li v-for="(item,index) in cartItem" :key="index">
                ...
                <div class="good-price">{{item.price}} x {{item.num}}</div>
                <div class="good-total">{{item.UnitPrice}}</div>
              </li>
            </ul>
          </div>
          ...
          <div class="detail">
            <div class="item">
              ...
              <span class="item-val">{{cartItem.length}}件</span>
            </div>
            <div class="item">
              <span class="item-name">商品总价：</span>
              <span class="item-val">{{total}}元</span>
            </div>
            <div class="item">
    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          <div class="item">
            <input type="text" class="input" placeholder="姓名" v-model="newList.name">
            <input type="text" class="input" placeholder="手机号" v-model="newList.phone">
          </div>
          <div class="item">
            <select name="province"  v-model="newList.province">
              <option value="四川">四川</option>
              <option value="重庆">重庆</option>
              <option value="山西">山西</option>
            </select>
            <select name="city" v-model="newList.city">
              <option value="成都">成都</option>
              <option value="宜宾">宜宾</option>
              <option value="南充">南充</option>
            </select>
            <select name="district" v-model="newList.district">
              <option value="锦江区">锦江区</option>
              <option value="青羊区">青羊去</option>
              <option value="高新区">高新区</option>
              <option value="都江堰市">都江堰市</option>
            </select>
          </div>
          <div class="item">
            <textarea name="street" placeholder="详细地址" v-model="newList.address"></textarea>
          </div>
          <div class="item">
...
export default{
  ...
  mounted(){
    //计算总价
    this.cartItem.map( res => {
      let UnitPrice = parseInt(res.UnitPrice)
      return this.total += UnitPrice
    })
  },
  methods:{
    // 打开新增地址弹框
    ...
    submitAddress(){
      this.$store.dispatch("addAddress", this.newList);
      this.closeModal();
