        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              <div class="addr-info">
                <h2>小啊涛</h2>
                <div class="phone">178****0189</div>
                <div class="street">四川 成都市 都江堰市 青城山镇<br>东软大道</div>
                <div class="action">
              ...
              <div class="addr-info">
                <h2>小马哥</h2>
                <div class="phone">178****8221</div>
                <div class="street">山西 太原市 尖草坪区 <br>尖草坪一中</div>
                <div class="action">
                  <a href="javascript:;" class="fl">
                    <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                  </a>
          ...
          <div class="item-good">
            ...
            <ul>
              <li>
                <div class="good-name">
                  <img src="/imgs/nav-img/nav-2.jpg" alt="">
                  <span>美威 智利原味三文鱼排 240g/袋 4片装</span>
                </div>
                <div class="good-price">108元x2</div>
                <div class="good-total">108元</div>
              </li>
              <li>
                <div class="good-name">
                  <img src="/imgs/nav-img/nav-2.jpg" alt="">
